              ...
              <div className="p-6" onClick={handleContentClick}>
                ...
                {!showQuiz && !showQuizResults && (
                  <div className="mt-8 p-6 bg-emerald-50 rounded-lg border border-emerald-200">
                    ...
                    >
                      Start Quiz ({course.type === 'w2' && (lesson.order_index === 1 || lesson.order_index === 2 || lesson.order_index === 3) ? '150' : lesson.order_index * 10} XP Available)
                    </button>
                  </div>
                )}
              ...
              <div className="space-y-3">
                {course.lessons.map((lessonItem, index) => (
                  ...
                  >
                    ...
                    {(index <= 4 || (course.type === 'w2' && (index === 0 || index === 1))) && (
                      <div className="flex items-center mt-2">
                        <span className="text-xs bg-emerald-100 text-emerald-700 px-2 py-1 rounded">
                          XP Available: {course.type === 'w2' && (lessonItem.order_index === 1 || lessonItem.order_index === 2 || lessonItem.order_index === 3) ? '150' : lessonItem.order_index * 10}
                        </span>
                      </div>
                    )}
                  </button>
